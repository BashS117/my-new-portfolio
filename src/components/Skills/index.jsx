...
function Skills() {
  return (
    <section id='skills'>
      <h2 className='sm:text-[1.5rem] number-heading section-list-item before:[content:"03."]'>Skills</h2>

      <div className="skills-container mt-[150px] ">
        <div className="skill-icon"><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="48" height="48" viewBox="0 0 48 48">
